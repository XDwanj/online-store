...
class AlipayServiceImpl(
  ...
  override fun toPay(subject: String, money: BigDecimal): String {
    val pay = Factory.Payment
      .Page()
      .pay(subject, this.generateTradeNo(), money.toString(), "http://localhost:8080")
